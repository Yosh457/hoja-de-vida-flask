...
# Inicializamos la base de datos para poder usarla luego
db = SQLAlchemy()
...
def create_app():
    ...
    app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'un-valor-secreto-por-defecto')
    ...
    # Conectamos nuestra instancia 'db' con la aplicación Flask
    db.init_app(app)
    ...
    @app.route('/')
    def index():
        return "¡Hola Mundo! La aplicación Flask está funcionando."
